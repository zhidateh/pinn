...
P_back,x,y,P,rho,u,v,T,E,Et = init.loadData('train')
...
print("w= ", model.sess.run(model.weights))

##Testing 
P_back_test,x_test,y_test,P_test,rho_test,u_test,v_test,T_test,E_test,Et_test = init.loadData('test')
